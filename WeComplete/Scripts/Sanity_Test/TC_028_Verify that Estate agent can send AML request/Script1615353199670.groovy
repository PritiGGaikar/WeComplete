...
true) {
    WebUI.scrollToElement(findTestObject('Deal Status/AML_Section/btn_AML'), GlobalVariable.shortTime)
    ...
    true) {
        ...
        'Click on Member check box'
       CustomKeywords.'com.wecomplete.keywords.TestBase.clickUsingJS'(findTestObject('Object Repository/Deal Status/AML_Section/checkbox_member1'), GlobalVariable.shortTime)
