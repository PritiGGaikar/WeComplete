...
//WebUI.click(findTestObject('Quote/PriceCompare_Page/Property_Section/toggle_Sell'))
'Click on Sell toggle'
CustomKeywords.'com.wecomplete.keywords.TestBase.clickUsingJS'(findTestObject('Quote/PriceCompare_Page/Property_Section/toggle_Sell'), 
...
'Verify Selling & Buying  pop up is opened'
if (CustomKeywords.'com.wecomplete.keywords.TestBase.isElementPresent'(findTestObject('Object Repository/Quote/PriceCompare_Page/Property_Section/header_Sell and Buy pop up'), 
    ...
    'Verify Selling Property Details header'
    CustomKeywords.'com.wecomplete.keywords.TestBase.isElementPresent'(findTestObject('Object Repository/Quote/PriceCompare_Page/Property_Section/header_ Selling Property Details'), 
        GlobalVariable.shortTime)
